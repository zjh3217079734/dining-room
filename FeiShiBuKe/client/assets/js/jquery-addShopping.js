		...
		shoping:function(options){
			...
			var S={
				...
				addIcon:function(){
					...
					var icon = '<div id="cartIcon" style="width:50px;height:50px;padding:2px;background:#fff;border:solid 2px #e54144;overflow:hidden;position:absolute;z-index:890;'+$options.iconCSS+'"><img src="'+$options.iconImg+'" width="50" height="50" /></div>';
					return icon;
				}
			};
			S.init(); 
